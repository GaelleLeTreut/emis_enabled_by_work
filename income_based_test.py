...
ut.df_to_csv_with_comment( carbon_intensity_by_countries.loc[carbon_intensity_by_countries.index != 'UZ',:], OUTPUTS_PATH + 'carbon_intensity_by_countries.csv', '% file automatically generated by ' + this_file + eol + '% downstream carbon intensity by industries, for France and RoW')
