...
ut.df_to_csv_with_comment( carbon_intensity_by_class, output_path + 'carbon_intensity_by_wage_class.csv', '% file automatically generated by ' + this_file + eol + '% downstream carbon intensity by wage classes')
